# -*- coding: utf-8 -*-
"""
Created on Fri Jul 24 10:42:19 2020

@author: CaioBrighenti
@modified: Peter Law
"""
...
scrapeBbalRef(1980, 2020, 'https://www.basketball-reference.com/leagues/NBA_*SEASON*_per_game.html','per_game_stats','D:/bteststat/season-stats-pergame')
...
scrapeBbalRef(1980, 2020, 'https://www.basketball-reference.com/leagues/NBA_*SEASON*_advanced.html','advanced_stats','D:/bteststat/season-stats-advanced')
# grab MVP stats
scrapeBbalRef(1980, 2019, 'https://www.basketball-reference.com/awards/awards_*SEASON*.html','nba_mvp','D:/bteststat/mvp-award-stats', False)
# grab ROY stats (bad)
scrapeBbalRef(2019, 2019, 'https://www.basketball-reference.com/awards/awards_*SEASON*.html','all_roy','D:/bteststat/roy-award-stats', False)
# grab DPOY stats (bad)
scrapeBbalRef(1980, 2019, 'https://www.basketball-reference.com/awards/awards_*SEASON*.html','Defensive_Player_of_the_Year','D:/bteststat/DPOY-award-stats', False)
# grab 6MOY stats (bad)
scrapeBbalRef(1980, 2019, 'https://www.basketball-reference.com/awards/awards_*SEASON*.html','Sixth_Man_of_the_Year','D:/bteststat/6MOY-award-stats', False)
# grab standings stats
scrapeBbalRef(1980, 2020, 'https://www.basketball-reference.com/leagues/NBA_*SEASON*_standings.html', 'expanded_standings','D:/bteststat/season-standings', False)
# All star stats (bad)
scrapeBbalRef(1985, 2018, 'https://www.basketball-reference.com/allstar/NBA_*SEASON*.html', 'East','D:/bteststat/MVP-Roster', False)
# grab season player stat per game
scrapeBbalRef(1980, 1980, 'https://www.basketball-reference.com/leagues/NBA_*SEASON*_rookies.html','rookies','D:/bteststat/Rookie-Season-Stats', False)
